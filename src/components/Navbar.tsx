      ...
      <div className="max-w-7xl mx-auto px-6 h-full flex items-center justify-between gap-6">
        ...
        <Link href="/" className="flex items-center gap-2.5 flex-shrink-0">
          ...
          <span className="font-bold text-base hidden sm:block" style={{ color: "var(--ink)" }}>
            Midnight <span style={{ color: "#5645d4" }}>Elite</span>
          </span>
        </Link>
        ...
        <div className="hidden md:flex items-center gap-2 flex-shrink-0">
          {isLoading ? (
            <div className="flex items-center gap-2">
              <div className="w-16 h-8 rounded-lg animate-pulse" style={{ background: "var(--hairline)" }} />
              <div className="w-9 h-9 rounded-lg animate-pulse" style={{ background: "var(--hairline)" }} />
              <div className="w-24 h-9 rounded-md animate-pulse" style={{ background: "var(--hairline)" }} />
            </div>
          ) : user ? (
            <>
              <CoinBalance />
                ...
                {dropdownOpen && (
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between gap-2.5 px-4 py-2.5">
                      <span className="flex items-center gap-2.5 text-sm font-medium" style={{ color: "var(--charcoal)" }}>
                        <Moon size={15} style={{ color: "var(--stone)", flexShrink: 0 }} />
                        Chế độ tối
                      </span>
