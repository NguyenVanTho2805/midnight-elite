        ...
        <div className="space-y-4">
          {reviews.map(r => (
            <div key={r.id} className="pb-4" style={{ borderBottom: "1px solid var(--hairline)" }}>
              ...
              <p className="text-sm leading-relaxed" style={{ color: "var(--slate)" }}>{r.comment}</p>
            </div>
          ))}
        </div>
      )}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="flex items-center gap-2 text-xs" style={{ color: "var(--stone)" }}>
            <Link href="/khoa-hoc" style={{ color: "#5645d4" }}>Khóa học</Link>
            <span>›</span>
            <Link href={`/khoa-hoc?category=${encodeURIComponent(course.category)}`} style={{ color: "#5645d4" }}>{course.category}</Link>
            <span>›</span>
          ...
          <div className="rounded-xl overflow-hidden" style={{ background: "var(--canvas)", border: "1px solid var(--hairline)" }}>
            ...
            {course.introVideo && extractYouTubeId(course.introVideo) ? (
              ...
              <div className="relative h-56 sm:h-72 flex items-center justify-center"
                style={{ background: "linear-gradient(145deg, #001a6e, #5645d4)" }}>
              ...
              <div className="grid grid-cols-2 gap-3">
                {[
                  ...
                  <div key={s.label} className="rounded-xl p-3 text-center"
                    ...
                    <div className="text-base font-extrabold" style={{ color: "#5645d4" }}>{s.value}</div>
                      ...
                      const inner = (
                        <>
                          ...
                          <div className="flex-1 min-w-0">
                            <span className="text-sm" style={{ color: isAccessible ? "#5645d4" : "var(--steel)", fontWeight: isAccessible ? 600 : 400 }}>
                              {lesson.title}
                            </span>
                            {lesson.isFree && (
                          ...
                          {isAccessible && (
                            <span className="text-xs flex-shrink-0 flex items-center gap-0.5" style={{ color: "#5645d4" }}>
                              <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 16 16" stroke="currentColor" strokeWidth="1.5"><polygon points="5,3 13,8 5,13" fill="#5645d4" stroke="none"/></svg>
                              Xem
                            </span>
                          )}
                        </>
          ...
          <div className="rounded-xl p-6 sticky top-20"
            ...
            <div className="mb-5">
              <div className="flex items-baseline gap-2 mb-1">
                <span className="text-3xl font-extrabold" style={{ color: "#5645d4" }}>{course.price.toLocaleString("vi-VN")}đ</span>
                {discount > 0 && (
            ...
            <div className="space-y-2.5 pt-4" style={{ borderTop: "1px solid var(--hairline)" }}>
              {[
                ...
                <div key={g} className="flex items-center gap-2 text-xs" style={{ color: "var(--slate)" }}>
